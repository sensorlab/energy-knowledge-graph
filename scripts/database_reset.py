...
def load_data(conn:Connection, df : pd.DataFrame, loadprofiles : dict, consumption: dict) -> None:
    """
...
def reset_database(data_path : Path, loadprofiles_path : Path, consumption_data : Path) -> None:
    """
    ...
    with engine.connect() as conn:
        ...
        # populate dataset
        load_data(conn, df, loadprofiles, consumption)
